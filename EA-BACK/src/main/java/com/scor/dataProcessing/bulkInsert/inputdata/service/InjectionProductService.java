...
@Service
public class InjectionProductService implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8684058342926504800L;

	private static final int DECIMAL_SCALE_12 = 12;
	
    private final static Logger LOGGER = Logger.getLogger(InjectionProductService.class);
	...
	public InjectionProductService(ResultColumnPivot resultColumnPivot, ResultProperties resultProperties) throws Exception {
        fixedSchema = resultColumnPivot.getProductPivot();
        ...
        map.put("dbTable", "dbo.PRODUCT_INPUT_DATA");
	...
	public void inject(String path, int datasetId) {
        LOGGER.info("Inserting Product File Begin");
        ...
        LOGGER.info("Inserting Product File finished: " + path + " in : " + (dateEnd.getTime() - dateBegin.getTime()) + " ms");
