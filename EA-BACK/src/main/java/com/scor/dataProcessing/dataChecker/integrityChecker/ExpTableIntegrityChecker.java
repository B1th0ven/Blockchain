...
public class ExpTableIntegrityChecker implements InterfaceToIntegrityChecker {

	private static final long serialVersionUID = -7235138681972013223L;
	private static final ExpTableIntegrityChecker instance = new ExpTableIntegrityChecker();

	private ExpTableIntegrityChecker() {
	};

	public static ExpTableIntegrityChecker getInstance() {
		return instance;
	}

	public ControlResults run(Map<String, List<String>> refData , String path, String type) throws Exception {
