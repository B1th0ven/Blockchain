...
@Service
public class InjectionPolicyService implements Serializable {
    ...
    private final static Logger LOGGER = Logger.getLogger(InjectionPolicyService.class);
	...
	public InjectionPolicyService(ResultColumnPivot resultColumnPivot, ResultProperties resultProperties) throws Exception {
        fixedSchema = resultColumnPivot.getPolicyPivot();
        ...
        map.put("dbTable", "dbo.POLICY_INPUT_DATA");
	...
	public void inject(String path, int datasetId) {
        LOGGER.info("Inserting Policy File Begin");
        ...
        LOGGER.info("Inserting Policy File finished: " + path + " in : " + (dateEnd.getTime() - dateBegin.getTime()) + " ms");
