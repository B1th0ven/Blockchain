...
@Service
public class InjectionIbnrUdfService implements Serializable {
/**
	 * 
	 */
    ...
    private final static Logger LOGGER = Logger.getLogger(InjectionIbnrUdfService.class);
	...
	public InjectionIbnrUdfService(ResultColumnPivot resultColumnPivot, ResultProperties resultProperties) throws Exception {
        fixedSchema = resultColumnPivot.getIbnrUdfPivot();
        ...
        map.put("dbTable", "dbo.IBNR_UDF_INPUT_DATA");
	...
	public void inject(String path, int runid) {
        LOGGER.info("Inserting IBNR UDF File Begin");
        ...
        LOGGER.info("Inserting IBNR UDF File finished: " + path + " in : " + (dateEnd.getTime() - dateBegin.getTime()) + " ms");
