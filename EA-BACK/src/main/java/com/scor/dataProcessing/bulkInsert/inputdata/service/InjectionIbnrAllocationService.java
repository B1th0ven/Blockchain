...
@Service
public class InjectionIbnrAllocationService implements Serializable {
/**
	 * 
	 */
    ...
    private final static Logger LOGGER = Logger.getLogger(InjectionIbnrAllocationService.class);
	...
	public InjectionIbnrAllocationService(ResultColumnPivot resultColumnPivot, ResultProperties resultProperties) throws Exception {
        fixedSchema = resultColumnPivot.getIbnrAllocationPivot();
        ...
        map.put("dbTable", "dbo.IBNR_ALLOCATION_INPUT_DATA");
	...
	public void inject(String path, int runid) {
        LOGGER.info("Inserting IBNR Allocation File Begin");
        ...
        LOGGER.info("Inserting IBNR Allocation File finished: " + path + " in : " + (dateEnd.getTime() - dateBegin.getTime()) + " ms");
